...
async fn run() {
    let mut app = App::new("WebGPU Post Processing - Step 9 - 3D-LUTs").await;
    ...
    let lut_textures: &[(&str, &str)] = &[
        (
            "custom",
            "resources/images/lut/3d-lut-orange-to-green-s16.png",
        ),
    ...
    app.run(RenderMode::Once, move |frame: &Frame| {
        ...
        let lut = wgpu_fun::setting_f64("lut", 2.0) as usize % lut_bind_groups.len();
        frame.queue.write_buffer(
